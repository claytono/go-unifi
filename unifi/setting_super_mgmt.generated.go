...
func (dst *SettingSuperMgmt) KnownJSONFields() map[string]struct{} {
...
func (dst *SettingSuperMgmt) SetAdditionalFields(ef map[string]json.RawMessage) {
...
func (c *client) UpdateSettingSuperMgmt(ctx context.Context, site string, s *SettingSuperMgmt) (*SettingSuperMgmt, error) {
	...
	result, err := c.SetSetting(ctx, site, SettingSuperMgmtKey, struct {
		*SettingSuperMgmt
