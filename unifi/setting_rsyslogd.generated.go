...
func (dst *SettingRsyslogd) KnownJSONFields() map[string]struct{} {
...
func (dst *SettingRsyslogd) SetAdditionalFields(ef map[string]json.RawMessage) {
...
func (c *client) UpdateSettingRsyslogd(ctx context.Context, site string, s *SettingRsyslogd) (*SettingRsyslogd, error) {
	...
	result, err := c.SetSetting(ctx, site, SettingRsyslogdKey, struct {
		*SettingRsyslogd
