...
func (dst *SettingUsg) KnownJSONFields() map[string]struct{} {
...
func (dst *SettingUsg) SetAdditionalFields(ef map[string]json.RawMessage) { dst.AdditionalFields = ef }
...
func (dst *SettingUsgDNSVerification) KnownJSONFields() map[string]struct{} {
	return map[string]struct{}{
		"domain":               {},
		"primary_dns_server":   {},
...
func (dst *SettingUsgDNSVerification) SetAdditionalFields(ef map[string]json.RawMessage) {
...
func (c *client) UpdateSettingUsg(ctx context.Context, site string, s *SettingUsg) (*SettingUsg, error) {
	s.Key = SettingUsgKey
	result, err := c.SetSetting(ctx, site, SettingUsgKey, struct {
		*SettingUsg
